                  ...
                  <label htmlFor='game' className='font-semibold'>Qual o game?</label>
                   ...
                   <select 
                      ...
                      className=" 
                        ...
                        focus:text-white
                      " 
                      aria-label="Escolha o game"
                      defaultValue=''
                      >
                        
                        <option disabled>Escolha o game que deseja jogar</option>
                       { games.map(game => {
                        return(
                ...
                <div className="flex gap-6">
                  <div className='flex flex-col gap-2'>
                    <label htmlFor="weekDays">Quando costuma jogar?</label>
                      <ToggleGroup.Root onValueChange={setWeekDays} value={weekDays} type='multiple' className='grid grid-cols-4 gap-1' >
